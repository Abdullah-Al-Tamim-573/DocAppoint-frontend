...
const HowItWorksCards = ({
  ...
  return (
    <>
      <div className=" relative z-10 max-w-[180px] mx-auto text-center py-3 px-5 rounded-2xl transition-all duration-500 hover:bg-white hover:shadow-xl hover:-translate-y-2 cursor-pointer">
